...
public static class AccuracyRecipeSearch
{
        ...
        FixedRateBondRequest baseRequest)
    {
        ...
        var model = new ScheduleResolvedCashflowChebyshevBondPricer(pricer, scaledRequest);
    ...
    private static AccuracyRecipeModelSummary BuildScheduleResolvedCashflowKernelModel(
        ...
        IReadOnlyList<SurrogateValidationPoint> factorPoints)
    {
        var model = new ScheduleResolvedCashflowChebyshevBondPricer(pricer, request);
