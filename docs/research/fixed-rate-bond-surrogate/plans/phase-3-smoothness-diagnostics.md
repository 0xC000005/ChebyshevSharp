...
- [x] Wait for CI/review feedback, then merge the Phase 3 PR or explicitly close it without merge.
- [x] Record the PR outcome in `status.md` and tracking issue `#191` before starting Phase 4.
